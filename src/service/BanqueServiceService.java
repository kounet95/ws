 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8585/ws?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8585/ws?wsdl");
    ...
    public Conversion getConversionPort() {
        return super.getPort(new QName("http://service/", "conversionPort"), Conversion.class);
    }
    ...
    public Conversion getConversionPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "conversionPort"), Conversion.class, features);
    }
